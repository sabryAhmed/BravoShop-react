...
import { Prodect_JSon } from './ProdectJSON';

function Prodect({addTocard,AddToheart}) {
        ...
        return (
          ...
          <div className="card ">
            ...
            <div className='card-body  '>
              ...
              <p className='text-center'>{value.price} <del className='text-primary'>{value.discount}</del></p>
            ...
            <div className="proccess">
              <div>
                <FaCartShopping className='i' onClick={()=>{addTocard(value)}}/>
              </div>
  
              <div>
                  
                <FaHeart className='i' onClick={()=>{AddToheart(value)}} />
